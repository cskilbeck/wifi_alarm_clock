...
void app_main(void)
{
    ...
    audio_element_handle_t audio_decoder = esp_decoder_init(&auto_dec_cfg, auto_decode, 5);
    ...
    periph_wifi_cfg_t wifi_cfg = {
        .wifi_config.sta.ssid = "3 Byfeld Gardens",
        .wifi_config.sta.password = "titwp2012",
    };
